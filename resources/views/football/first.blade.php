        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <a href='football'> <img src="{{ asset('/img/football/slider/fotball.jpg') }}" alt="New York"
                ...
                <div class="item">
                    <a href='football'> <img src="{{ asset('/img/football/slider/xx.jpg') }}" alt="New York"
                                             width="1200" height="700">
                        <div class="carousel-caption">
                            <h3>Football Products</h3>
                            <p>We love football !</p>
                ...
                <div class="item">
                    <a href='football'> <img src="{{ asset('/img/football/slider/belgia.jpg') }}" alt="New York"
                                             width="1200" height="700">
                        <div class="carousel-caption">
                            <h3>Football Products</h3>
                            <p>We love football !</p>
                ...
                <div class="item">
                    <a href='football'> <img src="{{ asset('/img/football/slider/gemania.jpg') }}" alt="New York"
                                             width="1200" height="700">
                        <div class="carousel-caption">
                            <h3>Football Products</h3>
                            <p>We love football !</p>
                ...
                <div class="item">
                    <a href='football'> <img src="{{ asset('/img/football/slider/france.jpg') }}" alt="New York"
                                             width="1200" height="700">
                        <div class="carousel-caption">
                            <h3>Football Products</h3>
                            <p>We love football !</p>
                ...
                <div class="item">
                    <a href='football'> <img src="{{ asset('/img/football/slider/italy.jpg') }}" alt="New York"
                                             width="1200" height="700">
                        <div class="carousel-caption">
                            <h3>Football Products</h3>
                            <p>We love football !</p>
                ...
                <div class="item">
                    <a href='football'> <img src="{{ asset('/img/football/slider/best.jpg') }}" alt="New York"
                                             width="1200" height="700">
                        <div class="carousel-caption">
                            <h3>Football Products</h3>
                            <p>We love football !</p>
